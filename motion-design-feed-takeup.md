...
1. Carrier tape ของเครื่อง ต้นแบบ อาจไม่ใช่ tape มาตรฐานสำหรับป้อนเข้า SMT feeder ทั่วไป (เช่น ใช้กับชิ้นส่วนที่ไม่ใช่ SMD) จึงไม่ถูกผูกกับกฎ 4mm-multiple
